...
(* File: pa_vof.ml by Yoann Padioleau.
 Heavily based on pa_sexp_conv.ml.
 Could use value_of of ocaml-orm-sqlite ? They dont handle 
 parametrized types :( sexplib does! 
...
module Generate_sexp_of = struct
  let mk_abst_call _loc tn rev_path =
    <:expr< $id:Gen.ident_of_rev_path _loc (("vof_" ^ tn) :: rev_path)$ >>

  (* Conversion of type paths *)
  let sexp_of_path_fun _loc id =
    match Gen.get_rev_id_path id [] with
    | ["unit"] -> <:expr< Ocaml.vof_unit >>
    | ["bool"] -> <:expr< Ocaml.vof_bool >>
    | ["string"] -> <:expr< Ocaml.vof_string >>
    | ["char"] -> <:expr< Ocaml.vof_char >>
    | ["int"] -> <:expr< Ocaml.vof_int >>
    | ["float"] -> <:expr< Ocaml.vof_float >>
    | ["int32"] -> <:expr< Ocaml.vof_int32 >>
    | ["int64"] -> <:expr< Ocaml.vof_int64 >>
    | ["nativeint"] -> <:expr< Ocaml.vof_nativeint >>
    | ["big_int"; "Big_int"] -> <:expr< Ocaml.vof_big_int >>
    | ["nat"; "Nat"] -> <:expr< Ocaml.vof_nat >>
    | ["num"; "Num"] -> <:expr< Ocaml.vof_num >>
    | ["ratio"; "Ratio"] -> <:expr< Ocaml.vof_ratio >>
    | ["ref"] -> <:expr< Ocaml.vof_ref >>
    | ["t"; "Lazy"] | ["lazy_t"] -> <:expr< Ocaml.vof_lazy >>
    | ["option"] -> <:expr< Ocaml.vof_option >>
    | ["list"] -> <:expr< Ocaml.vof_list >>
    | ["array"] -> <:expr< Ocaml.vof_array >>
    | ["t"; "Hashtbl"] -> <:expr< Ocaml.vof_hashtbl >>
  ...
  let sexp_of_td _loc type_name tps rhs =
    ...
    in
    let bnd = Gen.idp _loc ("vof_" ^ type_name) in
